...
# ACDS 16.0 211 linux 2018.10.17.14:40:53
...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/parallels/altera_lite/16.0/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/submodules/niosHello_mm_interconnect_0_rsp_demux_002.sv"                     -work rsp_demux_002                                -cdslib ./cds_libs/rsp_demux_002.cds.lib                               
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/submodules/niosHello_mm_interconnect_0_cmd_mux_002.sv"                       -work cmd_mux_002                                  -cdslib ./cds_libs/cmd_mux_002.cds.lib                                 
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/submodules/niosHello_mm_interconnect_0_router_004.sv"                        -work router_004                                   -cdslib ./cds_libs/router_004.cds.lib                                  
  ...
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/peripheral_LED.vhd"                                               -work peripheral_LED_0                             -cdslib ./cds_libs/peripheral_LED_0.cds.lib                            
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/niosHello_onchip_memory2_1.v"                                     -work onchip_memory2_1                             -cdslib ./cds_libs/onchip_memory2_1.cds.lib                            
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/niosHello_onchip_memory2_0.v"                                     -work onchip_memory2_0                             -cdslib ./cds_libs/onchip_memory2_0.cds.lib                            
  ...
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nioshello_rst_controller.vhd"                                                                                                                                                                          
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nioshello_rst_controller_001.vhd"                                                                                                                                                                      
fi
