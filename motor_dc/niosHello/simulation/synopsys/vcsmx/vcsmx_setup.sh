...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/niosHello_mm_interconnect_0_rsp_demux_002.sv"                     -work rsp_demux_002                               
  ...
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/niosHello_mm_interconnect_0_cmd_mux_002.sv"                       -work cmd_mux_002                                 
  ...
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/niosHello_mm_interconnect_0_router_004.sv"                        -work router_004                                  
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/peripheral_LED.vhd"                                               -work peripheral_LED_0                            
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/niosHello_onchip_memory2_1.v"                                     -work onchip_memory2_1                            
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/niosHello_onchip_memory2_0.v"                                     -work onchip_memory2_0                            
