...
alias com {
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/niosHello_mm_interconnect_0_rsp_demux_002.sv"                     -work rsp_demux_002                               
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/niosHello_mm_interconnect_0_rsp_demux.sv"                         -work rsp_demux                                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/niosHello_mm_interconnect_0_cmd_mux_002.sv"                       -work cmd_mux_002                                 
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/niosHello_mm_interconnect_0_router_004.sv"                        -work router_004                                  
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/niosHello_onchip_memory2_1.v"                                     -work onchip_memory2_1                            
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/niosHello_onchip_memory2_0.v"                                     -work onchip_memory2_0                            
